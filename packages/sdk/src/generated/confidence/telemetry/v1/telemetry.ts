...
export function libraryTraces_LibraryFromJSON(object: any): LibraryTraces_Library {
  switch (object) {
    case 0:
    case 'LIBRARY_UNKNOWN':
      return LibraryTraces_Library.LIBRARY_UNKNOWN;
    case 1:
...
export function libraryTraces_LibraryToJSON(object: LibraryTraces_Library): string {
  switch (object) {
    case LibraryTraces_Library.LIBRARY_UNKNOWN:
...
export function libraryTraces_TraceIdFromJSON(object: any): LibraryTraces_TraceId {
  switch (object) {
    ...
    case 3:
    case 'TRACE_ID_FLAG_EVALUATION':
      return LibraryTraces_TraceId.TRACE_ID_FLAG_EVALUATION;
    case -1:
    case 'UNRECOGNIZED':
    default:
...
export function libraryTraces_TraceIdToJSON(object: LibraryTraces_TraceId): string {
  switch (object) {
    ...
    case LibraryTraces_TraceId.TRACE_ID_FLAG_EVALUATION:
      return 'TRACE_ID_FLAG_EVALUATION';
...
export interface LibraryTraces_Trace {
  ...
  evaluationTrace?: LibraryTraces_Trace_EvaluationTrace | undefined;
}
...
export interface LibraryTraces_Trace_EvaluationTrace {
  reason: LibraryTraces_Trace_EvaluationTrace_EvaluationReason;
  errorCode: LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode;
}
...
export function libraryTraces_Trace_EvaluationTrace_EvaluationReasonFromJSON(
  object: any,
): LibraryTraces_Trace_EvaluationTrace_EvaluationReason {
  switch (object) {
    case 0:
    case 'EVALUATION_REASON_UNSPECIFIED':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_UNSPECIFIED;
    case 1:
    case 'EVALUATION_REASON_TARGETING_MATCH':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_TARGETING_MATCH;
    case 2:
    case 'EVALUATION_REASON_DEFAULT':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_DEFAULT;
    case 3:
    case 'EVALUATION_REASON_STALE':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_STALE;
    case 4:
    case 'EVALUATION_REASON_DISABLED':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_DISABLED;
    case 5:
    case 'EVALUATION_REASON_CACHED':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_CACHED;
    case 6:
    case 'EVALUATION_REASON_STATIC':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_STATIC;
    case 7:
    case 'EVALUATION_REASON_SPLIT':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_SPLIT;
    case 8:
    ...
    case 'UNRECOGNIZED':
    default:
      return LibraryTraces_Trace_EvaluationTrace_EvaluationReason.UNRECOGNIZED;
  }
}

export function libraryTraces_Trace_EvaluationTrace_EvaluationReasonToJSON(
  object: LibraryTraces_Trace_EvaluationTrace_EvaluationReason,
): string {
  switch (object) {
    case LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_UNSPECIFIED:
      return 'EVALUATION_REASON_UNSPECIFIED';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_TARGETING_MATCH:
      return 'EVALUATION_REASON_TARGETING_MATCH';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_DEFAULT:
      return 'EVALUATION_REASON_DEFAULT';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_STALE:
      return 'EVALUATION_REASON_STALE';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_DISABLED:
      return 'EVALUATION_REASON_DISABLED';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_CACHED:
      return 'EVALUATION_REASON_CACHED';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_STATIC:
      return 'EVALUATION_REASON_STATIC';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_SPLIT:
...
export enum LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode {
...
export function libraryTraces_Trace_EvaluationTrace_EvaluationErrorCodeFromJSON(
  object: any,
): LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode {
  switch (object) {
    case 0:
    case 'EVALUATION_ERROR_CODE_UNSPECIFIED':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_UNSPECIFIED;
    case 1:
    case 'EVALUATION_ERROR_CODE_PROVIDER_NOT_READY':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_PROVIDER_NOT_READY;
    case 2:
    case 'EVALUATION_ERROR_CODE_FLAG_NOT_FOUND':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_FLAG_NOT_FOUND;
    case 3:
    case 'EVALUATION_ERROR_CODE_PARSE_ERROR':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_PARSE_ERROR;
    case 4:
    case 'EVALUATION_ERROR_CODE_TYPE_MISMATCH':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_TYPE_MISMATCH;
    case 5:
    case 'EVALUATION_ERROR_CODE_TARGETING_KEY_MISSING':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_TARGETING_KEY_MISSING;
    case 6:
    case 'EVALUATION_ERROR_CODE_INVALID_CONTEXT':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_INVALID_CONTEXT;
    case 7:
    case 'EVALUATION_ERROR_CODE_PROVIDER_FATAL':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_PROVIDER_FATAL;
    case 8:
    case 'EVALUATION_ERROR_CODE_GENERAL':
      return LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_GENERAL;
    case -1:
    case 'UNRECOGNIZED':
    default:
      return LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.UNRECOGNIZED;
  }
}

export function libraryTraces_Trace_EvaluationTrace_EvaluationErrorCodeToJSON(
  object: LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode,
): string {
  switch (object) {
    case LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_UNSPECIFIED:
      return 'EVALUATION_ERROR_CODE_UNSPECIFIED';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_PROVIDER_NOT_READY:
      return 'EVALUATION_ERROR_CODE_PROVIDER_NOT_READY';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_FLAG_NOT_FOUND:
      return 'EVALUATION_ERROR_CODE_FLAG_NOT_FOUND';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_PARSE_ERROR:
      return 'EVALUATION_ERROR_CODE_PARSE_ERROR';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_TYPE_MISMATCH:
      return 'EVALUATION_ERROR_CODE_TYPE_MISMATCH';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_TARGETING_KEY_MISSING:
      return 'EVALUATION_ERROR_CODE_TARGETING_KEY_MISSING';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_INVALID_CONTEXT:
      return 'EVALUATION_ERROR_CODE_INVALID_CONTEXT';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_PROVIDER_FATAL:
      return 'EVALUATION_ERROR_CODE_PROVIDER_FATAL';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.EVALUATION_ERROR_CODE_GENERAL:
      return 'EVALUATION_ERROR_CODE_GENERAL';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationErrorCode.UNRECOGNIZED:
    default:
      return 'UNRECOGNIZED';
  }
}
...
function createBaseLibraryTraces_Trace(): LibraryTraces_Trace {
  return {
    id: 0,
    millisecondDuration: undefined,
    requestTrace: undefined,
    countTrace: undefined,
...
export const LibraryTraces_Trace: MessageFns<LibraryTraces_Trace> = {
  encode(message: LibraryTraces_Trace, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.evaluationTrace !== undefined) {
      LibraryTraces_Trace_EvaluationTrace.encode(message.evaluationTrace, writer.uint32(42).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.evaluationTrace = LibraryTraces_Trace_EvaluationTrace.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): LibraryTraces_Trace {
    return {
      ...
      evaluationTrace: isSet(object.evaluationTrace)
        ? LibraryTraces_Trace_EvaluationTrace.fromJSON(object.evaluationTrace)
        : undefined,
    };
  },
  ...
  toJSON(message: LibraryTraces_Trace): unknown {
    ...
    if (message.evaluationTrace !== undefined) {
      obj.evaluationTrace = LibraryTraces_Trace_EvaluationTrace.toJSON(message.evaluationTrace);
    }
    return obj;
  },
};
...
function createBaseLibraryTraces_Trace_EvaluationTrace(): LibraryTraces_Trace_EvaluationTrace {
  return { reason: 0, errorCode: 0 };
}

export const LibraryTraces_Trace_EvaluationTrace: MessageFns<LibraryTraces_Trace_EvaluationTrace> = {
  encode(message: LibraryTraces_Trace_EvaluationTrace, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.reason !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LibraryTraces_Trace_EvaluationTrace {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseLibraryTraces_Trace_EvaluationTrace();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): LibraryTraces_Trace_EvaluationTrace {
    return {
      reason: isSet(object.reason) ? libraryTraces_Trace_EvaluationTrace_EvaluationReasonFromJSON(object.reason) : 0,
      errorCode: isSet(object.errorCode)
        ? libraryTraces_Trace_EvaluationTrace_EvaluationErrorCodeFromJSON(object.errorCode)
        : 0,
    };
  },

  toJSON(message: LibraryTraces_Trace_EvaluationTrace): unknown {
    const obj: any = {};
    if (message.reason !== 0) {
      obj.reason = libraryTraces_Trace_EvaluationTrace_EvaluationReasonToJSON(message.reason);
    }
    if (message.errorCode !== 0) {
      obj.errorCode = libraryTraces_Trace_EvaluationTrace_EvaluationErrorCodeToJSON(message.errorCode);
    }
    return obj;
  },
};
