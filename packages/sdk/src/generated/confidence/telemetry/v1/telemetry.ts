...
export interface LibraryTraces_Trace_EvaluationTrace {
  evaluationReason: LibraryTraces_Trace_EvaluationTrace_EvaluationReason;
}
...
export function libraryTraces_Trace_EvaluationTrace_EvaluationReasonFromJSON(
  ...
  switch (object) {
    case 0:
    case 'EVALUATION_REASON_UNKNOWN':
...
export function libraryTraces_Trace_EvaluationTrace_EvaluationReasonToJSON(
  ...
  switch (object) {
    case LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_UNKNOWN:
      return 'EVALUATION_REASON_UNKNOWN';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_SUCCESS:
      return 'EVALUATION_REASON_SUCCESS';
    case LibraryTraces_Trace_EvaluationTrace_EvaluationReason.EVALUATION_REASON_FLAG_NOT_FOUND:
...
export const LibraryTraces_Trace_EvaluationTrace: MessageFns<LibraryTraces_Trace_EvaluationTrace> = {
  encode(message: LibraryTraces_Trace_EvaluationTrace, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.evaluationReason !== 0) {
      writer.uint32(8).int32(message.evaluationReason);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.evaluationReason = reader.int32() as any;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): LibraryTraces_Trace_EvaluationTrace {
    return {
      evaluationReason: isSet(object.evaluationReason)
        ? libraryTraces_Trace_EvaluationTrace_EvaluationReasonFromJSON(object.evaluationReason)
        : 0,
    };
  },
  ...
  toJSON(message: LibraryTraces_Trace_EvaluationTrace): unknown {
    const obj: any = {};
    if (message.evaluationReason !== 0) {
      obj.evaluationReason = libraryTraces_Trace_EvaluationTrace_EvaluationReasonToJSON(message.evaluationReason);
    }
    return obj;
  },
};
